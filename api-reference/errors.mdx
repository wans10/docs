---
title: "Errors"
description: "Learn how to handle errors in LLM Hub API interactions. Comprehensive guide to error codes, messages, and best practices for error handling."
icon: 'triangle-exclamation'
---

For errors, LLM Hub returns a JSON response with the following shape:
...
Otherwise, the returned HTTP response status will be <code>
HTTPStatus.S200_OK</code>
