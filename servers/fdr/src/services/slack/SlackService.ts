...
export interface SlackService {
  ...
  notifyFailedToRegisterDocs(
    request: FailedToRegisterDocsNotification
  ): Promise<void>;
  notifyFailedToRevalidatePaths(
    request: FailedToRevalidatePathsNotification
  ): Promise<void>;
  notifyFailedToDeleteIndexSegment(
    request: FailedToDeleteIndexSegment
  ): Promise<void>;
...
export class SlackServiceImpl implements SlackService {
  ...
  async notifyGeneratedDocs(
    request: GeneratingDocsNotification
  ): Promise<void> {
  ...
  public async notifyFailedToRegisterDocs(
    request: FailedToRegisterDocsNotification
  ): Promise<void> {
    try {
      await this.client.chat.postMessage({
  ...
  public async notifyFailedToDeleteIndexSegment(
    request: FailedToDeleteIndexSegment
  ): Promise<void> {
