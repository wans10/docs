...
describe("S3 Service", () => {
  it.skip("Test S3 Upload URLs", async () => {
    ...
    const startUploadDocsResponse =
      await s3Service.createPresignedDocsAssetsUploadUrlWithClient({
    ...
    const startUploadSourceResponse =
      await s3Service.createPresignedApiDefinitionSourceUploadUrlWithClient({
