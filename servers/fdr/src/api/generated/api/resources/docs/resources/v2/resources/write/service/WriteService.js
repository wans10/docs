...
export class WriteService {
    ...
    toRouter() {
        ...
        this.router.post("/set-is-archived", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.methods.setIsArchived(req, {
                    send: () => __awaiter(this, void 0, void 0, function* () {
                        res.sendStatus(204);
                    }),
                    cookie: res.cookie.bind(res),
                ...
                if (error instanceof errors.FernRegistryError) {
                    switch (error.errorName) {
                        ...
                        case "UnauthorizedError":
                            break;
                        default:
                            console.warn(`Endpoint 'setIsArchived' unexpectedly threw ${error.constructor.name}.` +
                                ` If this was intentional, please add ${error.constructor.name} to` +
                                " the endpoint's errors list in your Fern Definition.");
                    }
                    yield error.send(res);
