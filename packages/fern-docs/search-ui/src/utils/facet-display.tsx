...
const FACET_DISPLAY_MAP: Record<string, Record<string, ReactNode>> = {
  ...
  availability: {
    ...
    PublicBeta: (
      <AvailabilityBadge availability="PublicBeta" rounded variant="subtle" />
    ),
    Beta: <AvailabilityBadge availability="Beta" rounded variant="subtle" />,
    PrivateBeta: (
      <AvailabilityBadge availability="PrivateBeta" rounded variant="subtle" />
    ),
    LimitedAvailability: (
      <AvailabilityBadge
    ...
    Preview: (
      <AvailabilityBadge availability="Preview" rounded variant="subtle" />
    ),
    PreRelease: (
      <AvailabilityBadge availability="PreRelease" rounded variant="subtle" />
    ),
    Alpha: <AvailabilityBadge availability="Alpha" rounded variant="subtle" />,
    Experimental: (
      <AvailabilityBadge availability="Experimental" rounded variant="subtle" />
    ),
    Internal: (
      <AvailabilityBadge availability="Internal" rounded variant="subtle" />
    ),
    InDevelopment: (
      <AvailabilityBadge
    ...
    Deprecated: (
      <AvailabilityBadge availability="Deprecated" rounded variant="subtle" />
    ),
    Retired: (
      <AvailabilityBadge availability="Retired" rounded variant="subtle" />
    ),
  },
} as const;
...
const FACET_SMALL_DISPLAY_MAP: Record<string, Record<string, ReactNode>> = {
  ...
  availability: {
    Stable: (
      <AvailabilityBadge availability="Stable" size="sm" variant="outlined" />
    ),
    GenerallyAvailable: (
      <AvailabilityBadge
        availability="GenerallyAvailable"
    ...
    Beta: (
      <AvailabilityBadge availability="Beta" size="sm" variant="outlined" />
    ),
    PrivateBeta: (
      <AvailabilityBadge
    ...
    Preview: (
      <AvailabilityBadge availability="Preview" size="sm" variant="outlined" />
    ),
    PreRelease: (
      <AvailabilityBadge
    ...
    Alpha: (
      <AvailabilityBadge availability="Alpha" size="sm" variant="outlined" />
    ),
    Experimental: (
      <AvailabilityBadge
    ...
    Internal: (
      <AvailabilityBadge availability="Internal" size="sm" variant="outlined" />
    ),
    InDevelopment: (
      <AvailabilityBadge
        availability="InDevelopment"
    ...
    Sunset: (
      <AvailabilityBadge availability="Sunset" size="sm" variant="outlined" />
    ),
    Deprecated: (
      <AvailabilityBadge
    ...
    Retired: (
      <AvailabilityBadge availability="Retired" size="sm" variant="outlined" />
    ),
  },
} as const;
...
export function getFacetDisplay(
  ...
  return (
    ...
    (titleCase ? FACET_DISPLAY_NAME_TITLE_CASE_MAP : FACET_DISPLAY_NAME_MAP)[
      facet
    ]?.[value] ??
    value
  );
