...
export const Error = {
    domainNotRegisteredError: (): FernRegistry.docs.v2.read.getDocsUrlMetadata.Error.DomainNotRegisteredError => {
        return {
            error: "DomainNotRegisteredError",
        };
    },

    _unknown: (fetcherError: core.Fetcher.Error): FernRegistry.docs.v2.read.getDocsUrlMetadata.Error._Unknown => {
        return {
            error: undefined,
