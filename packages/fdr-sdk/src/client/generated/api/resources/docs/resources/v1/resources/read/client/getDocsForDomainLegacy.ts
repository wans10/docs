...
export const Error = {
    ...
    _unknown: (fetcherError: core.Fetcher.Error): FernRegistry.docs.v1.read.getDocsForDomainLegacy.Error._Unknown => {
        return {
            error: undefined,
    ...
    _visit: <_Result>(
        value: FernRegistry.docs.v1.read.getDocsForDomainLegacy.Error,
